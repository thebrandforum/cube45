              ...
              <div className="container mx-auto px-4 md:px-8">
                <div className="flex items-center justify-center py-3 md:py-4">
                  <div className="flex items-center space-x-2 md:space-x-8 text-base md:text-xl">
                    ...
                    <span className="text-black">|</span>
                    <Link href="/room/b" className="text-black hover:text-gray-700 cursor-pointer font-bold">
                      B동
                    </Link>
                    <span className="text-black">|</span>  
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-2 gap-4 md:gap-16 mb-8 md:mb-16">
                ...
                <div className="grid grid-cols-2 gap-2 md:gap-8">
                  {/* 왼쪽 - 제목 */}
                  <div>
                    <h3 className="text-[11px] md:text-lg font-medium text-black">B Zone</h3>
                  ...
                  <div className="space-y-1 md:space-y-3 text-[10px] md:text-base">
                    <div>
                      ...
                      <span className="text-black">• {bSummary?.areaRange || '로딩중...'}</span>
                    </div>
                    <div>
                      <span className="text-black">기준인원</span><br />
                      <span className="text-black">• {bSummary?.standardCapacityRange || '로딩중...'}</span>
                    </div>
                    <div>
                      <span className="text-black">최대인원</span><br />
                      <span className="text-black">• {bSummary?.maxCapacityRange || '로딩중...'}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 md:gap-8">
                  ...
                  <div className="space-y-1 md:space-y-3 text-[10px] md:text-base">
                    ...
                    <div>
                      ...
                      <span className="whitespace-pre-wrap break-words text-black">• {getContent('info_pool')?.content || '실내, 야외 수영장, 혹은 없음'}</span>
                    </div>
                  </div>
                </div>
              </div>
